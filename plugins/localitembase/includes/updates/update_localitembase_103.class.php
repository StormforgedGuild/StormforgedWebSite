...
if (!class_exists('update_localitembase_103')){
	class update_localitembase_103 extends sql_update_task{

		public $author		= 'GodMod';
		public $version		= '1.0.3';    // new version
		public $name		= 'Localitembase 1.0.3 Update';
		...
		*/
		public function __construct(){
			...
			$this->langs = array(
				'english' => array(
					'update_localitembase_103'	=> 'Localitembase 1.0.3 Update Package',
					'update_function' 			=> 'Update Parser',
				),
				'german' => array(
					'update_localitembase_103'	=> 'Localitembase 1.0.3 Update Paket',
